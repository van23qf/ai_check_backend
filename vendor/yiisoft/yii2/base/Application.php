 ...
 * @property \yii\db\Connection $papDb The database connection. This property is read-only.
 ...
 * @property \abhimanyu\config\components\IConfig $config
 * @property \api\components\AliYunOss $oss
...
abstract class Application extends Module
{
     ...
     */
    public function getPapAdminDb()
    {
        return $this->get('papAdminDb');
    }
     ...
     * @return \yii\db\Connection
     */
    public function getPapDb(){
        return Yii::$app->get('papDb');
    }
