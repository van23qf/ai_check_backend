...
class ActiveRecord extends BaseActiveRecord
{
     ...
     * @param string $textField  名称字段名
     * @param null $groupField   分组字段名
    ...
    {
        $key = get_class($this) . $valueField . $textField . $groupField . $sort . (is_string($condition)?$condition:Json::encode($condition));
